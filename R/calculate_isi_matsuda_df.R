...
#' 
#' `calculate_isi_matsuda_df()` requires a dataframe input with time, glucose, insulin columns. 
#' 
...
#'
calculate_isi_matsuda_df <- function(df, timeCol=time, glucoseCol=glucose, insulinCol=insulin,
