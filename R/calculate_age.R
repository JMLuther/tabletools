...
#'
#' @examples
#' calculate_age(dob = "8/12/1975", date_format = "mdy")
#' calculate_age(dob = "1975-08-12", date_format = "ymd")
#' calculate_age(dob = "1975-08-12", date_format = "ymd", units = "days")
#' calculate_age(dob = "1975-08-12", date_format = "ymd", units = "weeks")
