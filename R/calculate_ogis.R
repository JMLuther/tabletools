...
#'
#' `calculate_ogis()` accepts vectors for time, glucose, insulin, height, and
#' weight.
#'
...
#'
#' @return OGIS Index as a single value (\eqn{ml min^{-1} m^2})
#' @export
#' @examples
...
#' insulin = c(15, 150, 0)
#' calculate_ogis(time = time,  # 344.5
#'                glucose = glucose,
#'                insulin = insulin,
...
#' insulin = c(90, 900, 0)
#' calculate_ogis(time = time, time_units="hrs",  # 345
...
#' glucose = c(90, 135, 115)
#' insulin = c(15, 150, 0)
#' calculate_ogis_180(time = time,  # 344.5
#'                glucose = glucose,
#'                insulin = insulin,
#'                height=170, height_units = "cm",
#'                weight = 70, weight_units = "kg")

calculate_ogis <- function(time, glucose, insulin, height, weight, 
