...
#' calculate_isi_belfiore(time, glucose, insulin, bmi=30)
#'
#' # handling data stored in a dataframe
#' ogtt1 <- data.frame(time=c(0, 30, 60, 90, 120),              # minutes
#'                     glucose=c(93, 129, 178, 164, 97),        # mg/dL
#'                     insulin=c(12.8, 30.7, 68.5, 74.1, 44.0)) # uU/mL
#' calculate_isi_belfiore(ogtt1$time, ogtt1$glucose, ogtt1$insulin, bmi=30)
#'
...
#' calculate_isi_belfiore(ogtt2$time, ogtt2$glucose, ogtt2$insulin, bmi=30)
...
calculate_isi_belfiore <- function(time, glucose, insulin, 
  ...
  isi_belfiore = 2/((gb_bar*ins_bar+1)/C)
